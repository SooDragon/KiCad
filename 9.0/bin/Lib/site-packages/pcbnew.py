...
class PCB_TABLE(BOARD_ITEM_CONTAINER):
    ...
    def RunOnDescendants(self, aFunction, aDepth=0):
        r"""RunOnDescendants(PCB_TABLE self, std::function< void (BOARD_ITEM *) > const & aFunction, int aDepth=0)"""
        return _pcbnew.PCB_TABLE_RunOnDescendants(self, aFunction, aDepth)
    ...
    def GetHash(self):
        r"""GetHash(PCB_TABLE self) -> size_t"""
        return _pcbnew.PCB_TABLE_GetHash(self)
...
class FOOTPRINT(BOARD_ITEM_CONTAINER):
    ...
    def TransformPadsToPolySet(self, aBuffer, aLayer, aClearance, aMaxError, aErrorLoc, aSkipNPTHPadsWihNoCopper=False):
        r"""TransformPadsToPolySet(FOOTPRINT self, SHAPE_POLY_SET aBuffer, PCB_LAYER_ID aLayer, int aClearance, int aMaxError, ERROR_LOC aErrorLoc, bool aSkipNPTHPadsWihNoCopper=False)"""
        return _pcbnew.FOOTPRINT_TransformPadsToPolySet(self, aBuffer, aLayer, aClearance, aMaxError, aErrorLoc, aSkipNPTHPadsWihNoCopper)
